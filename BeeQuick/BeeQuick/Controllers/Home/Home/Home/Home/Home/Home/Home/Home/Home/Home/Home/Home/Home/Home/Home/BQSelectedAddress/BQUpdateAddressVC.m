...
- (void)viewDidLoad {
    ...
    self.tableView.estimatedRowHeight = 292;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
   ...
   UITableViewCell *cell =  [[[NSBundle mainBundle] loadNibNamed:@"BQAddressCell" owner:nil options:nil]lastObject];
