...
- (void)viewDidLoad {
    ...
    self.lineImageView.center = CGPointMake(self.areaimageView.center.x, self.areaimageView.frame.origin.y-self.navigationController.navigationBar.frame.size.height);
    // 1. 定义输入
...
- (void)setupAnimations {
    ...
    CGPoint targetPoint = CGPointMake(originPoint.x, originPoint.y + self.areaimageView.frame.size.height - self.lineImageView.frame.size.height - 25);
